                    ...
                    <div className='mid_back_imgs' >
                        <div className='middle_divs'>
                            ...
                            <div className='middle_div_bottomz'>
                                <div className='mid_div_info'>
                                    <div className='mid_div_info_head'>You are the first liquidity provider. The ratio of
                                        tokens you add will set the price of this pool. Once you
