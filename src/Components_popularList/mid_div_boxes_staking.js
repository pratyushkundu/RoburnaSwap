...
const Mid_div_boxes_staking = ({data}) => {
  return (

        <>
            <div className='img_logos_1'>
                <img src={data.logo} className='BinanceCoin' />
                {/* <img src="images/RIP.png" className='RIP' /> */}
            </div>
            <div className='mid_div_box_inner1_1'>
            ...
            <div className='mid_div_box_inner3_1'>
                <div className='midd_heading_5'>
                    <div className='midd_heading_5_1'>{data.Duration}</div>
                    <img className="questionMark_img_1" src="images/Vector.png" />
                </div>
                <div className='mid_heading_6'>{data.DurationDays}</div>
            </div>
            <div className='mid_div_box_inner4_1'>
...
export default Mid_div_boxes_staking;